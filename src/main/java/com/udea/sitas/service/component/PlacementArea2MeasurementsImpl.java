...
@Slf4j
@Service
public class PlacementArea2MeasurementsImpl implements PlacementAreaMeasurements{

    private static final String LOG_PREFIX = "Placement area id 2 measurements Service >>";
    private static final double MAX_HEIGHT_AREA = 90;
    private static final double MAX_LENGTH_AREA = 70;
    private static final double MAX_WIDTH_AREA = 140;
